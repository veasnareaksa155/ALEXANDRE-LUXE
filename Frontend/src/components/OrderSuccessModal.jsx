        ...
        <div className="py-6 text-center">
            ...
            <div className="flex justify-between border-b border-neutral-200 pb-2">
              ...
              <span className="font-mono font-bold text-black">
                {orderData.order_number ||
                  (orderData.id
                    ? `LX${String(orderData.id).padStart(6, "0")}`
                    : "LX000001")}
              </span>
            </div>
            <div className="flex justify-between border-b border-neutral-200 pb-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2">
            <Button
              ...
              className="bg-neutral-100 hover:!bg-neutral-200 text-black border-neutral-300 font-bold text-xs tracking-widest uppercase h-11 px-4 w-full sm:w-auto flex items-center justify-center gap-1.5 cursor-pointer"
            >
              <PrinterOutlined />
              DOWNLOAD RECEIPT
            </Button>
            ...
            <Button
              type="primary"
              onClick={onClose}
              className="bg-black text-white hover:!bg-neutral-800 font-bold text-xs tracking-widest uppercase h-11 px-6 w-full sm:w-auto cursor-pointer"
            >
              CONTINUE SHOPPING
            </Button>
            ...
            {onOpenDeliveryTracking && (
              <Button
                ...
                className="bg-amber-500 hover:!bg-amber-400 text-black border-amber-600 font-extrabold text-xs tracking-widest uppercase h-11 px-5 w-full sm:w-auto flex items-center justify-center gap-1.5 cursor-pointer"
              >
